...
event-subscription =
    ...
    *[1] Ваш бесплатный пробный период закончился. Оформите подписку, чтобы продолжить пользоваться сервисом!
    ...
    Вы также можете пригласить друзей в бота и получить 7 дней бесплатной подписки за каждого приглашённого по вашей ссылке:
...
event-referral =
    ...
    Пользователь присоединился по вашей пригласительной ссылке! Чтобы получить награду, убедитесь, что он оформит пробную подписку.
