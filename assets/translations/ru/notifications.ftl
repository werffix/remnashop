...
ntf-requirement =
    ...
    Также необходимо ознакомиться и принять Условия использования (https://telegra.ph/Polzovatelskoe-soglashenie-08-15-10) и Политику конфиденциальности (https://telegra.ph/Politika-konfidencialnosti-08-15-1).
